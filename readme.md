...
2. thats all
 ...
 - Sys Req: 
Visual C++ 2010 redist (x86 , 64-bit version req x64) so-called `vcrun2010` wine(`vcredist_x86.exe / vcredist_x64.exe`) ;cpu with sse2 set(builds without it ,uncheck in properties before);
Windows 7    
